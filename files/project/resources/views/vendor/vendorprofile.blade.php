                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('VendorProfileController@update',['id' => $vendor->id]) !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Location Address <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="address" placeholder="Vendor Email" value="{{$vendor->address}}" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="reg_name23"> Your Region <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="reg_name23" name="region" class="form-control" required>
                                        <option value="{{$vendor->region}}">{{$vendor->region}}</option>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="phone" placeholder="Vendor Phone Number" value="{{$vendor->phone}}" required="required" type="tel" pattern="^\d{10}$" title="Please enter a valid phone number">
                                </div>
                            </div>
