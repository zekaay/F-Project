                        ...
                        <div id="response"></div>
                            <form role="form" method="POST" action="{{ route('account.withdraw.submit') }}" class="form-horizontal form-label-left">
                                ...
                                <div id="mobile" style="display: none;">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Enter Mobile Account<span class="required">*</span>

                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input name="mobile_acc" value="{{ old('mobile_acc') }}" placeholder="Enter Mobile Account" class="form-control" type="text">
                                        </div>
                                    </div>
                                ...
                                <div id="bank" style="display: none;">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Enter Account Name:<span class="required">*</span>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Enter Address:<span class="required">*</span>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Enter Bank Swift Code:<span class="required">*</span>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Additional Reference(Optional):<span class="required">*</span>
...
<script>
    $("#withmethod").change(function(){
        ...
        if(method == "Bank"){
            ...
            $("#mobile").hide();
            $("#mobile").find('input').attr('required',false);
        ...
        if(method == "Mobile"){
            ...
            $("#paypal").find('input').attr('required',false);
            $("#mobile").show();
            $("#mobile").find('input').attr('required',true);
        }
        if(method == ""){
            $("#bank").hide();
            $("#paypal").hide();
