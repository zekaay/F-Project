                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="text-total">{{\App\Order::where('customerid',Auth::user()->id)->count() }}</div>
                                <p class="titles">Product Purchased!</p>
                            </div>
                        </div>
                    </div>
                    <a class="panel-footer detail-link clearfix btn-block" href="{{url('vendor/purchase')}}"><span class="pull-left">View All</span><span class="pull-right"><i class="fa fa-chevron-circle-right"></i>
                    </span>
                    </a><!-- END panel-->
                </div>
            </div>
