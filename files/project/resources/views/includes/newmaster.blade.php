                        ...
                        <div class="line-entry">
                            ...
                            <div class="header-top-entry increase-icon-responsive login">
                                @if(Auth::guard('vendor')->guest())
                                    <a href="{{url('/vendor')}}" class="title"><i class="fa fa-user"></i> <span>{{$language->sign_in}}</span></a>
                                @else
                                    <a href="{{url('/vendor/dashboard')}}" class="title"><i class="fa fa-user"></i> <span>{{$language->my_account}}</span></a>
                                @endif
                            </div>
