                            ...
                            <div class="row">
                                ...
                                <form  action="" method="post" id="payment_form">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        @else
                                            <div class="form-group">
                                                <label for="shippingFull_name">full name <span>*</span></label>
                                                <input type="text" class="form-control" name="name" value="{{Auth::guard('vendor')->user()->name}}" placeholder="Full Name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">phone <span>*</span></label>
                                                <input type="text" class="form-control" name="phone" value="{{Auth::guard('vendor')->user()->phone}}" placeholder="Phone Number" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">emai <span>*</span></label>
                                                <input type="email" class="form-control" name="email" value="{{Auth::guard('vendor')->user()->email}}" placeholder="Email" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">address <span>*</span></label>
                                                <input type="text" class="form-control" name="address" value="{{Auth::guard('vendor')->user()->address}}" placeholder="Address" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">city <span>*</span></label>
                                                <input type="text" class="form-control" name="city" value="{{Auth::guard('vendor')->user()->city}}" placeholder="City" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">postal code <span>*</span></label>
                                                <input type="text" class="form-control" name="zip" value="{{Auth::guard('vendor')->user()->zip}}" placeholder="Postal Code" required>
                                            </div>
                                            <input type="hidden" name="customer" value="{{Auth::guard('vendor')->user()->id}}" />
                                        @endif
                                            <div class="form-group">
                                        ...
                                        <div id="mobile" style="display: none;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="txn_ids" placeholder="Transaction ID#">
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control order-notes" name="order_note" id="order_notes" cols="30" rows="5" style="resize: vertical;"></textarea>
                                    </div>
                                </div>
